    ...
    long>
{
    ...
    [MenuAuthorize(new[] { "CustomerList", "CustomerSystemList", "ServiceRequestCreate", "YkbServiceRequestCreate", "EkbServiceRequestCreate", "QnbServiceRequestCreate" }, MenuPermission.View)]
