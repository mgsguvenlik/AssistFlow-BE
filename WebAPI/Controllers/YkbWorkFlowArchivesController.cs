...
namespace WebAPI.Controllers
{
    ...
    public class YkbWorkFlowArchivesController : ControllerBase
    {
        ...
        private readonly ILogger<YkbWorkFlowArchivesController> _logger;

        public YkbWorkFlowArchivesController(
            IYkbWorkFlowService workFlowService,
            ILogger<YkbWorkFlowArchivesController> logger)
        {
        ...
        /// </summary>
        [HttpGet]
        public async Task<IActionResult> GetArchives([FromQuery] YkbWorkFlowArchiveFilterDto filter)
        {
