...
{
    /// <inheritdoc />
    public partial class addTechnicalServiceWorkSessionTBL : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TechnicalServiceWorkSessions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicalServiceWorkSessions", x => x.Id);
                });
        }
