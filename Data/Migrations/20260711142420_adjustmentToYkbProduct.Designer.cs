...
namespace Data.Migrations
{
    ...
    [Migration("20260711142420_adjustmentToYkbProduct")]
    partial class adjustmentToYkbProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Concrete.ProductPriceAdjustmentRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("IsValueEditable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(true);
                    ...
                    b.HasIndex("TenantId", "ProductId", "Code")
                        .IsUnique()
                        .HasDatabaseName("UX_ProductPriceAdjustmentRule_TenantId_ProductId_Code")
                        .HasFilter("[IsDeleted] = 0");

                    b.HasIndex("TenantId", "ProductId", "IsActive", "IsDeleted")
                        .HasDatabaseName("IX_ProductPriceAdjustmentRule_TenantId_ProductId_IsActive");

                    b.ToTable("ProductPriceAdjustmentRule", (string)null);
                });
            ...
            modelBuilder.Entity("Model.Concrete.ProductPriceAdjustmentRule", b =>
                {
                    b.HasOne("Model.Concrete.Product", "Product")
                        .WithMany("PriceAdjustmentRules")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Model.Concrete.Tenant", "Tenant")
                        .WithMany("ProductPriceAdjustmentRules")
                        .HasForeignKey("TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Concrete.Product", b =>
                {
                    ...
                    b.Navigation("PriceAdjustmentRules");
            ...
            modelBuilder.Entity("Model.Concrete.Tenant", b =>
                {
                    ...
                    b.Navigation("ProductPriceAdjustmentRules");
