...
{
    [Table("EkbTechnicalService", Schema = "ekb")]
    public class EkbTechnicalService : AuditableWithUserEntity
    {
        [Key]
        ...
        // Görseller
        public ICollection<EkbTechnicalServiceImage> EkbServicesImages { get; set; } = new List<EkbTechnicalServiceImage>();
        public ICollection<EkbTechnicalServiceFormImage> EkbServiceRequestFormImages { get; set; } = new List<EkbTechnicalServiceFormImage>();
    }
}
