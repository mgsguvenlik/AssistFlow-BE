...
{
    public sealed class QnbReportLineRowDto
    {
        ...
        public string? GLCode { get; set; }                   // boþ dönüyor (SP)
        public string? MGSDescription { get; set; }           // boþ dönüyor (SP)

        public string? Contract_No { get; set; }              // [Contract No]
        public string? CostType { get; set; }
        public string? Description { get; set; }              // boþ dönüyor (SP)
