...
{
    public class QnbFinishTechnicalServiceDto
    {
        [Required]
        ...
        [Required(ErrorMessage = "En az bir servis fotoðrafý yüklemelisiniz.")]
        [MinLength(1, ErrorMessage = "En az bir servis fotoðrafý seçin.")]
