...
{   
    public class AutofacBusinessModule : Module, ICoreModule
    {
        public void Load(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IEkbWorkFlowService), typeof(EkbWorkFlowService));
            ...
            services.AddScoped(typeof(IEkbOvertimeReportService), typeof(EkbOvertimeReportService));
